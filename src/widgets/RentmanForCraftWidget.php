...
namespace furbo\rentmanforcraft\widgets;

use furbo\rentmanforcraft\RentmanForCraft;
use furbo\rentmanforcraft\assetbundles\rentmanforcraftwidgetwidget\RentmanForCraftWidgetWidgetAsset;

use Craft;
use craft\base\Widget;

/**
 * Rentman for Craft Widget
 *
 ...
 * @since     1.0.0
 */
class RentmanForCraftWidget extends Widget
{
    ...
    {
        return Craft::t('rentman-for-craft', 'RentmanForCraftWidget');
    }
    ...
    {
        return Craft::getAlias("@furbo/rentmanforcraft/assetbundles/rentmanforcraftwidgetwidget/dist/img/RentmanForCraftWidget-icon.svg");
    }
    ...
    public function getSettingsHtml()
    {
        return Craft::$app->getView()->renderTemplate(
            'rentman-for-craft/_components/widgets/RentmanForCraftWidget_settings',
            [
                'widget' => $this
            ]
        );
    ...
    {
        Craft::$app->getView()->registerAssetBundle(RentmanForCraftWidgetWidgetAsset::class);

        return Craft::$app->getView()->renderTemplate(
            'rentman-for-craft/_components/widgets/RentmanForCraftWidget_body',
            [
