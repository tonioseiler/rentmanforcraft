...
namespace furbo\rentmanforcraft\assetbundles\rentmanforcraft;
...
/**
 * RentmanForCraftAsset AssetBundle
 *
...
class RentmanForCraftAsset extends AssetBundle
{
    ...
    public function init()
    {
        ...
        $this->sourcePath = "@furbo/rentmanforcraft/assetbundles/rentmanforcraft/dist";
        ...
        $this->js = [
            'js/RentmanForCraft.js',
        ];

        $this->css = [
            'css/RentmanForCraft.css',
        ];
