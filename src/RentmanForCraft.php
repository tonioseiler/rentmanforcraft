...
class RentmanForCraft extends Plugin
{
    ...
    private function attachEventHandlers(): void
    {
        ...
        //custom system messages,  removed: this is no longer used, as we now use the email/project.twig template that can be overridden with a (custom) site template
        /*
